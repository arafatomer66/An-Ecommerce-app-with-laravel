								...
								<div class="product-information"><!--/product-information-->
									...
									<span>
										@if ( !is_null($productDetails->offer_price)  )
											<span class="offer-price">Offer Price: {{ $productDetails->offer_price }} BDT</span>
											<span class="regular-price">Regular Price:<del> {{ $productDetails->regular_price }} BDT</del></span>
										@else
											<span>BDT {{ $productDetails->regular_price }}</span>
										@endif
